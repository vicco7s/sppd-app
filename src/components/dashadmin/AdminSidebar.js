        ...
        <aside className="w-64 bg-white shadow-lg h-screen sticky top-0 p-4 text-gray-800 flex flex-col shrink-0">
            ...
            <nav className="space-y-2 text-sm mb-4">
                ...
                <div className="relative">
                    <button
                        ...
                        className={`w-full text-left flex items-center justify-between gap-3 p-2.5 rounded-xl transition-all duration-300 focus:outline-none focus:ring-0 ${openPegawaiUser ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'}`}
                    >
                        <span>Pegawai & Kelola User</span>
                        <motion.span 
                            ...
                            >
                                <ul className="mt-1 ml-4 pl-2 border-l-2 border-gray-100 space-y-1 py-1">
                                    <button
                                        ...
                                        className={`w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 ${activeTab === 'pegawai' ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}
                                    >
                                        Pegawai
                                    </button>
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 ${activeTab === 'manage-users' ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}
                                    >
                                        Kelola User
                                    </button>
                                </ul>
                ...
                <div className="relative">
                    <button
                        ...
                        className={`w-full text-left flex items-center justify-between gap-3 p-2.5 rounded-xl transition-all duration-300 focus:outline-none focus:ring-0 ${openBendahara ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'}`}
                    >
                        <span>Bendahara</span>
                        <motion.span 
            ...
            <div className="mt-auto pt-6 border-t border-gray-100 -mx-4 px-4 space-y-1">
                ...
                <button
                    ...
                    className={`w-full text-left flex items-center gap-3 p-2.5 rounded-xl transition-all duration-300 text-sm ${activeTab === 'update-log' ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'}`}
                >
                    Update Log
                </button>
