...
export default function NotificationDropdown({ isOpen, notifications, unreadCount, onMarkAsRead }) {
  ...
  return (
    <div className="absolute right-0 top-full z-50 mt-3 w-[min(26rem,95vw)] max-w-[420px] overflow-hidden rounded-[26px] border border-slate-200/70 bg-white/80 shadow-[0_24px_60px_rgba(15,23,42,0.12)] backdrop-blur-[10px]">
